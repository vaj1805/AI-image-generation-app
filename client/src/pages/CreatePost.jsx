...
const CreatePost = () => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    if (!form.prompt || !form.photo) return alert('Please create an image first');
    try {
      setLoading(true);
    ...
    <section className="max-w-7xl mx-auto">
      <div>
        ...
        <p className="mt-2 text-[#666e75] text-[16px] max-w-[500px]">
          Create imaginative and visually pleasing images using AI
        </p>
      </div>
      ...
      <form className="mt-16 max-w-3xl" onSubmit={handleSubmit}>
        ...
        <div className="mt-10">
          <p className="mt-2 text-[#666e75] text-[14px]">
            Once image created you can share it with others
          </p>
          <button
            type="submit"
